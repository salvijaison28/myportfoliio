  ...
  <div className="bloggrid">
    ...
    <div className="blogcard">
      ...
      <div className="bloghover">
        <h2>Who I am</h2>
        <p>I love crafting work that feels personal and meaningful, something that stays with people. I’m always exploring new styles and pushing myself creatively, especially through collaboration. With roots in collage and painting, I’m drawn to the little details in everyday life, the moments and objects we often overlook and I turn them into sparks for fresh ideas.</p>
      </div>
    </div>
    ...
    <div className="blogcardtall">
      ...
      <div className="bloghover">
        <h2>My Style</h2>
        <p>My style is about honoring the beauty in everyday life, the small moments, textures, and gestures that usually go unnoticed. I use color grading to shape the mood and bring out subtle emotion, and I’m drawn to the imperfect and unpolished parts of the world. They tell honest stories, and capturing that quiet charm is what makes my work feel alive.</p>
      </div>
    </div>
