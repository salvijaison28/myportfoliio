  ...
  <div className="bloggrid">
    ...
    <div className="blogcard">
      ...
      <div className="bloghover">
        <h2>Who I am</h2>
        <p>I love crafting work that feels personal and meaningful, something that stays with people. I’m always exploring new styles and pushing myself creatively, especially through collaboration. With roots in collage and painting, I’m drawn to the small, overlooked details in everyday life and turn them into sparks for new ideas.</p>
      </div>
    </div>
